  ...
  return (
    <div className="w-full">
      ...
      <div className="fresh-air-container">
        <div className="bg-white shadow-lg rounded-bl-lg" style={{ position: 'relative' }}>
          <form
        onSubmit={onSubmit}
      ...
      >
        ...
        <div className="relative" ref={calWrapRef}>
          ...
          >
            <span className="text-lg font-medium text-gray-900">{dateLabel}</span>
            <svg
        ...
        <div className="relative" ref={passengersWrapRef}>
          <button
            ...
            style={{ borderBottomColor: '#778194', borderBottomWidth: '0.5px' }}
          >
            <span className="text-lg font-medium text-gray-900">{passengers} Passenger{passengers !== 1 ? 's' : ''}</span>
